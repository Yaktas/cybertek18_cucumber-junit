...
public class Hooks {
    ...
    public void tearDownScenario(Scenario scenario) {
      ...
      //  System.out.printf("scenario.isFailed()= "+scenario.isFailed());

        //#1 we need to take a screen shot using SELENIUM ----->
        //getScreenshotAs: to be able to use this method we have to cast our driver type to TakesScreenshotAs

        // byte[]screenshot= ((TakesScreenshot) Driver.getDriver()).getScreenshotAs(OutputType.BYTES);

       //#2 we are going to atach it into our report:using attach method
