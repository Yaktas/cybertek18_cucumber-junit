...
/*
    ...
    public void user_should_see_six_links_in_the_footer(List<String> linkStrings) {
        ...
        BELOW IS TIME EXEPTION AND WITH I AM ABLE TO SEE THE LIST OF ELEMENTS
*/
    @Then("User should see six links in the footer")
    public void user_should_see_six_links_in_the_footer(List<String> linkStrings) throws InterruptedException {
